...
# special commands
bindsym $mod+z exec scrot -u '%Y-%m-%d-%H-%M-%S_screenshot_$wx$h.jpg' -e 'mv $f ~/Pictures/'
bindsym $mod+x exec gnome-screenshot -i 
bindsym $mod+c exec scrot '%Y-%m-%d-%H-%M-%S_screenshot_$wx$h.jpg' -e 'mv $f ~/Pictures/'
bindsym $mod+p exec dmenu_run
bindsym $mod+o exec google-chrome
bindsym $mod+i exec nautilus
bindsym $mod+n exec subl
bindsym $mod+m exec notable

bindsym $alt+l exec i3lock -t -i ~/Pictures/background.png
...
bindsym $mod+e focus right # actually want to focus to right window, can it do that?
